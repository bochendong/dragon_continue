...
export const chaptersData = [
  {
    ...
    wordCount: 2006,
    chapter: '楔子',
    description: '故事的开始，神秘的梦境，路明非与康斯坦丁的初次相遇。',
...
他忽然觉得这声音那么悦耳，提醒他梦中的一切都是假的，他所在的，只是普普通通的人世。`
  },
  {
    ...
    wordCount: 2012,
    chapter: '第一幕',
    description: '普通高中生路明非的日常生活，星际争霸和QQ聊天。',
    content: `路明非在屏幕上无奈地打出"GG"（"GG"，指"GoodGame"，在竞技类游戏中称赞对方玩得好，也是认负的意思），而后切出了游戏。屏幕上显示的最后一个场景，是十二艘人类巡洋舰以华丽的大和炮聚焦射击，把他的母巢化作了一滩血水。
...
"一箱打折的袋装奶，半斤广东香肠，还有鸣泽要的新一期《最小说》，买完了赶快回来，把桌子上的芹菜给我摘了！还有去传达室看看有没有录美国来的信！还玩游戏？自己的事情一点不上心，要没人录取你，你考得上一本吗？在你身上花了那么多钱，有什么用？"婶婶的声音在隔壁炸雷般响起。
